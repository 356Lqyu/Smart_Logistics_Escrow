...
function validateDestination() {
    ...
    const isSame = originVal !== "" && destinationVal !== "" && originVal === destinationVal;
...
async function handleCreateAgreement(event) {
    ...
    try {
        ...
        if (
            ...
            throw new Error(
                `Minimum total escrow amount for ${PRIORITY_LABELS[priority]
        ...
        await supabaseClient
            ...
            .insert([{
                ...
                details: {
                    ...
                    escrow_funded: true,
                    status: "Created",
                    description: "Agreement created and escrow automatically funded and locked in the smart contract."
                }
            }]);
